...
module.exports = {
    ...
    run: async(client, interaction, container) => {
        ...
        .setAuthor({name: "Add a User", iconURL: config.serverIcon})
        .setThumbnail(config.serverIcon)
        .setColor(config.serverColor)
        .setDescription(`
        Please enter the id of the user you would like to add.
        ...
        *Note: Type cancel to quit.*`)
        ...
        interaction.channel.awaitMessages({filter, max: 1, time: 10000
            ...
            interaction.channel.permissionOverwrites.edit(adduser, { VIEW_CHANNEL: true });
            ...
            .setAuthor({name: "Added user to ticket", iconURL: config.serverIcon})
            .setThumbnail(config.serverIcon)
            .setColor(config.serverColor)
            .setDescription(`
            ${interaction.member} Has added ${adduser} to ticket ${interaction.channel}`)
